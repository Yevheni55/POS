...
function renderTable() {
  ...
  if (!filtered.length) {
    tableWrap.innerHTML = '<div class="empty-state"><div class="empty-state-icon">\uD83E\uDDF4</div>'
      + '<div class="empty-state-title">' + (searchTerm ? 'Žiadne výsledky' : 'Ziadny tovar') + '</div>'
...
export function init(container) {
  ...
  container.innerHTML = '<div class="top-bar">'
    + '<button class="btn-add" id="addBtn"><svg aria-hidden="true" viewBox="0 0 14 14"><line x1="7" y1="1" x2="7" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="1" y1="7" x2="13" y2="7" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg> Pridať tovar</button>'
